...
public class HexMap implements Serializable {
	...
	*/
	...
	/**
 	* ArrayList des positions de unités.
	*/
	...
	*/
	...
	/**
	* Initialise les unités pour 2 joueurs.
	* @see Hex
	* @see Forteresse
	*/
	...
	/**
	* Initialise les unités pour 3 joueurs.
	* @see Hex
	* @see Forteresse
	*/
	...
	/**
	* Initialise les unités pour 4 joueurs.
	* @see Hex
	* @see Forteresse
	*/
	...
	/**
	* Initialise les unités pour 5 et 6 joueurs.
	* @see Hex
	* @see Forteresse
	*/
	...
	*/
	...
	/**
	* Retourne le coût de déplacement.
	* @param start Hex
	* @param goal Hex
	* @return int
	* @see Hex
